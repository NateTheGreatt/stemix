 ...
 *
 * Sanitizes string input from "userModel-space" application code and normalizes
...
/**
 * Resolve a path given `dir`, `name`, and supported extensions.
 *
 * This is useful for loading code that needs to be compiled to JavaScript, such
 * as CoffeeScript.
 *
 * Examples:
 *
 *    resolveExt('config/environments', 'all', [ 'js', 'coffee' ]);
 *    // => config/environments/all.coffee
 *
 * @param {String} dir
 * @param {String} name
 * @param {Array} exts
 * @api private
 */
exports.resolveExt = function(dir, name, exts) {
...
/**
 * Resolve a path to another path with alternate supported extension.
 *
 * This is useful for loading code that needs to be compiled to JavaScript, such
 * as CoffeeScript.
 *
 * Examples:
 *
 *    resolveExt('config/routes.js', [ 'js', 'coffee' ]);
 *    // => config/routes.coffe
 *
 * @param {String} p
 * @param {Array} exts
 * @api private
 */
exports.resolveAltExt = function(p, exts) {
  var dir = path.dirname(p)
    , name = path.basename(p, path.extname(p));
  return exports.resolveExt(dir, name, exts);
}
