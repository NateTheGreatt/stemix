 ...
 *
 * For example, reusing existing middleware for a userModel API.
 *
 *     this.get('/userModel/:id', userModel.load, function(req, res) {
 *       res.json(req.locals.userModel);
 *     });
 *
 *
 * Options:
 ...
 * profile of the currently logged in userModel.  In this case, a singular resource
