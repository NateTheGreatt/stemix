 ...
 *          res.end('viewing userModel ' + req.body.userModel.name);
 *        });
 *
 *      $ curl -d 'userModel[name]=tj' http://local/
 *      $ curl -d '{"userModel":{"name":"tj"}}' -H "Content-Type: application/json" http://local/
 *
