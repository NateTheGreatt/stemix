 ...
 *  so the cookie becomes a browser-session cookie. When the userModel closes the
 ...
 *  are typically fine. For example below is a userModel-specific view counter:
 *
 *       connect()
 *         .use(connect.favicon())
 *         .use(connect.cookieParser())
 ...
 *  to remain for only the duration of the userModel-agent.
 *
 * ## Session#maxAge
 *
...
function session(options){
  ...
  // notify userModel that this store is not
